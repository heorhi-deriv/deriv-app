...
import { useCurrencyConfig, useWalletTransfer, useTransferMessageList } from '@deriv/hooks';
...
const WalletTransfer = observer(({ is_wallet_name_visible, setIsWalletNameVisible }: TWalletTransferProps) => {
    console.log('=> rerender WalletTransfer');
    ...
    const { message_list } = useTransferMessageList(from_account, to_account);
